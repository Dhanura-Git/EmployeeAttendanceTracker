...
const UserDashboard = () => {
    ...
    return (
        <Container className="mt-4">
                ...
                <Col>
                    {!clockedIn ? (
                        <div className="d-flex flex-column align-items-start">
                            ...
                            {totalHoursToday && (
                                <span className="ms-3 text-success">
                                    Total hours worked today: {totalHoursToday} hours
                                </span>
                            )}
                        </div>
                    ) : (
                        <div className="d-flex align-items-center">
                            ...
                            <span className="ms-3">⏳ {Math.floor(elapsedTime / 3600)}h {Math.floor((elapsedTime % 3600) / 60)}m {elapsedTime % 60}s</span>
                        </div>
                    )}
                </Col>
            </Row>
            ...
            <Row>
                <Col>
                    <Button variant="warning" onClick={() => setShowLeaveModal(true)}>Take Leave</Button>
                </Col>
            </Row>
